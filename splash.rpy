...
label splashscreen:
    ...
    python:
        mod_firstrun = ""
        try:
            mod_firstrun = renpy.file("firstrun").read(1)
        except:
    ...
    if not mod_firstrun:
        if persistent.first_run:
            ...
            scene black
            menu:
                "{cps=400}A previous save file for this mod has been found. Would you like to delete your save data and start over? {i}If you have a previous version of this mod, you should do so, or else it will break the mod!{/i}{/cps}"
    ...
    if not persistent.first_run:
        ...
        menu:
            "{cps=400}By playing [config.name] you agree that you have completed DDLC and accept any spoilers contained within, and you consent to your exposure to highly disturbing content, such as {i}glitchy, flashy images and disturbing, distorted soundtracks.{/i}{/cps}"
            "I agree.":
                pass
        scene tos2
        with Dissolve(1.5)
