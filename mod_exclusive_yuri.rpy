...
label mod_exclusive_yuri_1: # This label is necessary so you can jump into the scene if you get it on day 3 instead of day 2, using the different beginning in day3.rpy.
    ...
    "The way she acts is really obvious, but I decide to let it go anyway."
    ...
    menu:
        "Now that I look at it some more, this book seems intensely familiar..."
        "Is this that book about a girl who moves in with her sister and gets targeted by some people that escaped from a human experiment prison?":
            $ no_return()
            $ persistent.mc_awareness[5] = True
            y 2f "Um... not exactly..."
            y "Wait. Now that you mention it..."
            y "I feel like it used to be about that."
            y "But then I read it again, and it was slightly different..."
            if mod_chapter == 1: # If you got this scene on day 2
                "This is weird as hell... Is Yuri having the same kind of experiences I am?"
                "I wonder if I should tell her about it..."
                "But I decide to hold my tongue for now. I mean, I barely know her."
            else: # Otherwise, MC has already spoken to Natsuki and Yuri about his experiences.
                mc "Books don't change, Yuri."
                mc "It just happened again."
                mc "There's no way both of us just misremember."
                mc "Something's going on, and I just don't know what it is!"
                y 3l "Ah- you're right! This is really unsettling..."
                y "I'll make a point to look up the book's plot after I get home."
                mc "Sounds like a good idea. I'll do the same."
                $ persistent.lookup_portrait = True
            mc "So what do you remember it being about the last time?"
            y 1f "Well..."
            y "Mmm..."
        "Is this that book about a girl who gets pulled into a painting and it turns out to be a portal to some other world?":
            $ no_return()
            $ persistent.mc_awareness[5] = False
            y 2f "No... you must be thinking of a different book."
    ...
    y 2u "I hope so..."
    "I wonder why she's so into it, with such a dark story. I can tell by her intense reading expression."
    ...
    $ _history_list[-1].what = "But because they have their own goals, or their own philosophy that they believe in."
    ...
    stop sound
    $ style.say_dialogue = style.normal
    mc "Wait, Yuri, do you really think we're all worthless?"
    y 3v "Uh- what? Did I say something I didn't mean to?"
    if mod_chapter == 1:
        "Dammit. She didn't say it, did she? It was just another hallucination."
        "What the hell is happening to me?"
        mc "Uh, no, nevermind, I was just... nevermind."
    else: # If MC and Yuri and Natsuki have talked about their surreal experiences
        mc "... I don't know. I thought I heard you say that the world is full of horrible people and that we're all worthless, but after all the hallucinations I've been having, if you don't remember it, it was probably just me."
    y "Well..."
    y "I guess it's alright, then..."
    y 3a "But I feel like I should let you know that I have this problem..."
    ...
    mc "Well... I don't think there's anything wrong with you talking about something."
    ...
    $ del _history_list[-1:]
    if mod_chapter == 1:
        "I decide not to ask about what she said this time. It was probably just my head playing tricks on me again, and I don't want to embarrass myself."
    else:
        "I decide to ignore it this time. It's probably just me again."
    ...
    "I slide my desk until it's up against Yuri's, then hold my book more between the two of us."
    y 2v "Ah..."
    y "I-I suppose so..."
    ...
    if mod_chapter == 1:
        scene bg spoopy with dissolve_cg
    else:
...
label mod_exclusive_yuri_2:
    ...
    if persistent.mc_awareness[9]:
        $ persistent.mc_awareness[10] = True
        "Wait, somehow I know what's going to happen."
        "I remember it vividly."
        "She's going to cut herself."
        "Did I go back in time?"
        "But it's not like the rewinding that happened when I found her the first time."
        "I was thinking about if there were some way I could go back and stop her..."
        "And then it happened."
        "Holy s[sword]."
        if persistent.mc_know_player:
            "Hey, {i}you{/i}."
            "You mysterious force that fast-forwarded time to save me from the argument."
            "You did this too, didn't you?"
            "Thank you."
            "I don't know who you are, but..."
            "I'm not scared of all these surreal experiences anymore."
            "I'm sure you have something to do with it... and I trust you."
        else:
            python:
                points = 0
            ...
            if points >= 2:
                "Wait..."
                if persistent.mc_awareness[6]:
                    "The force that controlled my mouth before and fast-forwarded the argument to protect me..."
                else:
                    "The force that controlled my mouth before..."
                "That same force did this, didn't it?"
                "Hey, {i}you{/i}."
                "You out there..."
                "Thanks. I'll use this chance to stop Yuri from getting hurt."
                $ persistent.mc_know_player = True
            else:
                "I don't know how I have this chance, but I'm going to make use of it."
        "I'll go after her in just a second."
    ...
    if persistent.mc_awareness[10]:
        hide monika
        "I leave the clubroom to go find Yuri."
        scene bg corridor
        with wipeleft_scene
        $ currentpos = get_pos()
        play music "<from " + str(currentpos) + " loop 10.893>bgm/6o.ogg"
        "I know where she'll be, too."
        "I come in on Yuri holding a knife to her arm, about to cut."
        show yuri 3p at t11
        y "Ah- [player]! This isn't what it..."
        mc "Don't worry Yuri, I know already. I saw this happen."
        mc "Don't you remember? I waited for you, but you didn't come, so I went out to look for you, and I found you already done cutting."
        mc "But then some force sent me back in time so I'd have a chance to stop you."
        mc "Yuri, put the knife away. Cutting yourself won't help anything."
        y "Ah... [player], let me explain!"
        mc "No need. I've already heard your explanation."
        mc "And no, I don't think you're a freak or anything."
        mc "Now, do you want to go read?"
        y 3n "I-... thank you, [player]..."
        y "L-let's go..."
        jump read_with_yuri
    scene bg club_day
    with wipeleft_scene
    ...
    $ persistent.mc_awareness[9] = True
    y "I'm back."
    y "Thanks for -"
    mc "Wait one minute, Yuri!"
    y 3n "Ah- what is it?"
    "I take her out into the hallway."
    scene bg corridor
    with wipeleft_scene
    show yuri 3n at t11
    mc "I just... I remember going out to look for you just now because you were taking too long, and I found you cutting yourself with a knife, and then... and then time rewinded or something!"
    mc "Am I crazy?"
    y "I... [player]..."
    y 2l "No. I did it."
    mc "Yuri, why?"
    y "I can't explain it... but sometimes... my heart just... won't stop pounding. I can't calm down. It scares me. It makes me feel like I'm losing my mind... but cutting... always snaps me out of it."
    mc "... That's..."
    mc "There's gotta be another way."
    y 2t "Maybe. But can we please go read now?"
    "If only there was some way I could go back and stop her from cutting herself..."
    mc "I guess so."
label read_with_yuri:
    scene bg club_day
    with wipeleft_scene
    "We return to the clubroom."
    show yuri 1a at t11
    ...
    y "I can't..."
    y "[player]..."
    "Uh-oh... I did something stupid, didn't I?"
    ...
    "I done it now..."
    mc "Yuri, I'm sorry, what I did back there was really stupid. Please try to calm down, and don't cut yourself!"
    y "I can't..."
    ...
    y 3s "...to look..."
    y "...at you."
    "I feel like I should pull away..."
    "But I'm indecisive."
    hide yuri
    show yuri eyes
    $ pause(3.0)
...
label mod_exclusive_yuri_3:
    ...
    y 1a "If there's one thing that can make my reading time here any better, it's a nice cup of tea."
    y "Not to mention for yourself, as well."
    mc "Wait... Yuri, every word you just said is exactly the same as the last time this happened."
    y 3f "Eh? This happened before?"
    mc "Yeah. You said exactly those words, went out into the hallway by yourself, didn't come back for ten minutes, and I went out to look for you and found you cutting yourself with a pocket knife."
    y 3p "Ah!"
    y 2f "I remember now..."
    y "Still, I want to make some tea."
    mc "That's okay, but I'm coming with you this time."
label test:
    y "Uh... okay. I suppose that's a good idea."
    scene bg corridor with wipeleft
    play music t9
    show yuri 3t at t11
    y "You know, [player], there's something I've been thinking about."
    mc "Yeah?"
    ...
    mc "That's really sad... But you don't have to hide anymore. You have friends who want to accept you for who you are."
    y 2m "Yes... the literature club was the best thing that ever happened to me."
    ...
    mc "Yeah, I've seen. But don't worry Yuri, I still like you. I want to help you overcome this."
    y 2s "Ehe... I like that about you, [player]. You're such an understanding person."
    ...
    "I decide not to answer that question, and just let her keep speaking."
    ...
    y 1m "Yeah..."
    mc "Stay here? Don't you even want to read?"
    "I remember what happened after I fed Yuri the piece of chocolate."
    "{i}\"It even makes me not want to read...\"{/i}"
    play music hb
    show layer master at heartbeat
    ...
    mc "Oh god... Yuri, can you even hear me right now?"
    $ ac += 0.5
    show monika 1 onlayer front at malpha(ac / ad)
    y 1q "Ahaha..."
    $ ac += 0.5
    ...
    mc "Yuri, I'm seeing Monika on top of you."
    $ ac += 0.5
    show monika 1 onlayer front at malpha(ac / ad)
    y 1f "I have an idea."
    $ ac += 1
    ...
    "Is Monika doing something to her?"
    $ ac += 1
    show monika 1 onlayer front at malpha(ac / ad)
    ...
    "I've got to snap her out of this somehow!"
    $ ac += 1
    show monika 1 onlayer front at malpha(ac / ad)
    y "There's no need for us to be around Monika's slimy tongue anymore."
    "I don't know, maybe it's just me and Yuri isn't actually saying these things..."
    $ ac += 1
    show monika 1 onlayer front at malpha(ac / ad)
    ...
    menu:
        ...
        "Do nothing":
            $ no_return()
            $ persistent.left_yuri = False
        "Go back to the clubroom":
            $ no_return()
            hide monika onlayer front
            "I start to walk away from Yuri, but she grabs my arm."
            y 2y6 "[player], don't leave me! I {i}need{/i} to be with you right now!"
            "I pull away forcefully and run back to the clubroom."
            "I think time alone with me might be damaging Yuri's mind."
            "I don't understand how or why, but I have to try my best to prevent whatever's going to happen, and right now, with the information I have, this is my best guess."
            $ persistent.left_yuri = True
            return
    ...
    mc "I just hope your happy ending doesn't involve Natsuki or Monika getting hurt..."
    $ ac += 2
    show monika 1 onlayer front at malpha(ac / ad)
